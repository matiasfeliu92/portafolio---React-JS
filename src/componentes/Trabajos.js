...
const Trabajos = () => {
    ...
    const trabajos = [
        {titulo: "App de disney", descripcion1: "Consiste en una app realizada para Alkemy, donde se pueden guardar y editar los personajes de Disney", descripcion2: "Tecnologias usadas: Node Js, Express y MySql", link: "", rutaVideo: "", linkGit: "https://github.com/matiasfeliu92/Challenge-Backend-Alkemy--Node-Js"},
